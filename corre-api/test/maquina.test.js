...
// CÓPIA INDEPENDENTE das arestas legais, de propósito: o teste é a
// testemunha da tabela declarativa, não um derivado dela. Se alguém mexer
// na tabela (sabotagem ou descuido), a divergência aparece aqui.
const ARESTAS = [
  { de: null, tipo: 'criada', para: 1, autor: 'lojista' },
  { de: 1, tipo: 'pagamento_confirmado', para: 2, autor: 'sistema' },
  { de: 1, tipo: 'expirou', para: 8, autor: 'sistema' },
  { de: 1, tipo: 'cancelada', para: 10, autor: 'lojista' },
  { de: 2, tipo: 'motoboy_aceitou', para: 3, autor: 'motoboy' },
  { de: 2, tipo: 'cascata_esgotada', para: 9, autor: 'sistema' },
  { de: 2, tipo: 'cancelada', para: 10, autor: 'cliente' },
  { de: 3, tipo: 'coleta_confirmada', para: 4, autor: 'motoboy' },
  { de: 3, tipo: 'cancelada', para: 10, autor: 'painel', payload: { motivo: 'loja fechou no meio' } },
  { de: 4, tipo: 'pin_validado', para: 7, autor: 'motoboy' },
  { de: 4, tipo: 'entrega_falhou', para: 5, autor: 'motoboy' },
  { de: 4, tipo: 'cancelada', para: 10, autor: 'painel', payload: { motivo: 'mercadoria errada' } },
  { de: 5, tipo: 'devolucao_concluida', para: 11, autor: 'motoboy' },
  { de: 5, tipo: 'cancelada', para: 10, autor: 'painel', payload: { motivo: 'acordo com o cliente' } },
];
...
test('máquina de estados', async (t) => {
  ...
  await t.test('matriz exaustiva: para cada par estado × transição, ou é permitida ou é recusada — sem terceira possibilidade', async () => {
    let permitidas = 0;
    let recusadas = 0;
    for (const de of ESTADOS_ALCANCAVEIS) {
    ...
    const combinacoes = ESTADOS_ALCANCAVEIS.length * (TIPOS.length - 1);
